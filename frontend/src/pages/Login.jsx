...
const Login = () => {
  ...
  useEffect(() => {
    ...
    if (token) {
      // If token is in URL, fetch user info and login
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 text-sm">
            Sign in to your prompt manager
          </p>
        </div>
        ...
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8 shadow-2xl">
          ...
          <button
            ...
            className="w-full bg-white/5 hover:bg-white/10 border border-white/10 text-white font-medium py-3 rounded-xl transition-all duration-200 flex items-center justify-center gap-3 mb-6"
          >
