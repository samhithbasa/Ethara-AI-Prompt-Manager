      ...
      <div className="relative max-w-3xl mx-auto px-6 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-400 text-sm">
            Create a new prompt-response pair for AI training
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                placeholder="e.g. Python For Loop Explanation"
                required
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                placeholder="Enter the question or instruction given to AI..."
                required
                rows={4}
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                placeholder="Enter the ideal AI response or answer..."
                required
                rows={4}
                className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:border-purple-500/50 focus:bg-purple-500/5 transition-all duration-200 resize-none"
              />
